            ...
            <div class="row g-4">
                ...
                <div class="col-md-4">
                    <div class="card service-card h-100 p-3">
                        <img src="<?php echo e(asset('service-img-1-1.jpg')); ?>" class="card-img-top" alt="Standard Cleaning">
                        <div class="card-body">
                ...
                <div class="col-md-4">
                    <div class="card service-card h-100 p-3 shadow">
                        <img src="<?php echo e(asset('/service-img-1-2.jpg')); ?>" class="card-img-top" alt="Deep Cleaning">
                        <div class="card-body">
                ...
                <div class="col-md-4">
                    <div class="card service-card h-100 p-3">
                        <img src="<?php echo e(asset('/service-img-1-5.jpg')); ?>" class="card-img-top" alt="Move-in/out Cleaning">
                        <div class="card-body">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/2025 Projects/A1 Classic Garage/resources/views/home.blade.php ENDPATH**/ ?>