                                ...
                                <tr>
                                    ...
                                    <td> 
                                        ...
                                        <?php if($employee->profile_picture): ?>
                                            <img style='width:50px;' src="<?php echo e(asset('storage/' . $employee->profile_picture)); ?>" alt="Profile Picture" class="employee-table-profile-picture">
                                        <?php endif; ?>   
                    ...
                    <div class="col-12">
                        ...
                        <?php $__currentLoopData = $services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" name="services[]" value="<?php echo e($service->id); ?>" id="service_<?php echo e($service->id); ?>">
