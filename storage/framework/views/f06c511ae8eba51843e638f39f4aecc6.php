  ...
  <div style="max-width:700px; margin: 40px auto; background:#ffffff; border-radius:16px; box-shadow:0 12px 28px rgba(0,0,0,0.06); overflow:hidden;">
    ...
    <div style="padding: 40px 30px;">
      <div style="background:#f9fafc; padding:24px; border-radius:12px; border:1px solid #e6eaf0;">
        <h3 style="margin-top:0; font-size:16px; font-weight:600; color:#333;">Hello <?php echo new \Illuminate\Support\EncodedHtmlString($appointment->customer->name); ?>,</h3>
        ...
        <p style="font-size:15px; color:#555;">
          This is a friendly reminder for your upcoming appointment with <strong><?php echo new \Illuminate\Support\EncodedHtmlString($appointment->cleaner->name); ?></strong> scheduled for <strong><?php echo new \Illuminate\Support\EncodedHtmlString($date); ?></strong> between <strong><?php echo new \Illuminate\Support\EncodedHtmlString($start); ?> and <?php echo new \Illuminate\Support\EncodedHtmlString($end); ?></strong>.  
          The service booked is <strong><?php echo new \Illuminate\Support\EncodedHtmlString($appointment->service->service_name); ?></strong>.
        </p>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/2025 Projects/updatedecopros/resources/views/emails/reminder/index.blade.php ENDPATH**/ ?>