            ...
            <?php echo csrf_field(); ?>
                <div class="row gy-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="name" class="form-control" id="firstname" placeholder="Enter Full Name">
                    </div>
                    <div class="col-md-6">
                ...
                <div class='row gy-3'>
                    <div class="col-12">
                        ...
                        <input type="text" name="phone" class="form-control" id="cleaner_phone">
                    </div>
                    <div class="col-12">
                        <label class="form-label">Bio</label>
                        <textarea name="#0" class="form-control" rows="4" cols="50" id="cleaner_bio"></textarea>
                    </div>
                    <div class="col-12">
                        <label class="form-label">Price</label>
                        <input type="text" name="price" class="form-control" id="cleaner_bio" required>
                    </div>
                    <div class="col-12">
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\echopros1\echopros\resources\views/admin/cleaners/single_cleaner/profile.blade.php ENDPATH**/ ?>