...
<div class="dashboard-main-body">
    <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
        <h6 class="fw-semibold mb-0">Add employee's Availability</h6>
            <ul class="d-flex align-items-center gap-2">
                ...
                <li>-</li>
                <li class="fw-medium">Add employee Availability</li>
            </ul>
    </div>
                   ...
                   <div class="form-group d-flex gap-3 align-items-center" required>
                    ...
                    <?php $__currentLoopData = $employees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $employee): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="form-check d-flex align-items-center">
                            <input class="form-check-input" type="radio" name="employee_id" id="employee_<?php echo e($employee->id); ?>" value="<?php echo e($employee->id); ?>" required>
                            <label class="form-check-label" for="employee_<?php echo e($employee->id); ?>">
...
<script>
    document.querySelectorAll('input[name="employee_id"]').forEach((input) => {
        input.addEventListener('change', function () {
            document.querySelectorAll('.form-check').forEach(el => el.classList.remove('selected-employee'));
            this.closest('.form-check').classList.add('selected-employee');
        });
    });
</script>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/2025 Projects/A1ClassicGarage/resources/views/admin/Employees/add-availability.blade.php ENDPATH**/ ?>