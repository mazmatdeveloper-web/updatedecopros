    ...
    <form action="" class='filters-form'>
                ...
                <?php $__currentLoopData = $services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="more-options">
                        <input
                            ...
                            <?php echo e(in_array($service->id, old('services', $serviceIds ?? [])) ? 'checked' : ''); ?>
        ...
        <div class="col-md-3 cart-col" style='height:100vh;'>
                ...
                <div class="additional-services-div mb-4">
                    ...
                    <tr>
                        <td class='text-start'><?php echo e($booking['address']); ?></td>
                    </tr> 
                    </table>    
                </div>
                ...
                <div class="dimensions-div mb-4">
                    <table class='dimensions-table w-100'>
                            ...
                            <tr>
                            <td class='text-start' id='service_summary'>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/2025 Projects/A1ClassicGarage/resources/views/updated-frontend/booking-extended.blade.php ENDPATH**/ ?>