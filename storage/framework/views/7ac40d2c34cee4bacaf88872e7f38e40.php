                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="status" name="status">
                                        <?php $__currentLoopData = ['pending', 'confirmed', 'completed', 'cancelled']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($status); ?>" <?php echo e((old('status', $appointments->status) === $status) ? 'selected' : ''); ?>>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="cleaner" name="cleaner">
                                        ...
                                        <?php $__currentLoopData = $cleaners; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cleaner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($cleaner->id); ?>"
                                                <?php echo e($appointments->cleaner_id == $cleaner->id ? 'selected' : ''); ?>>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/2025 Projects/updatedecopros/resources/views/admin/appointments/edit.blade.php ENDPATH**/ ?>