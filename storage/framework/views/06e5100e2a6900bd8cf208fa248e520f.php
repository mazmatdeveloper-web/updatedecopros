    ...
    <div class="container-fluid">
        <div class="row d-flex justify-content-center">
            <div class="col-md-9 pt-4 pb-5">
                <a href="<?php echo e(route('booking')); ?>" class="btn btn-secondary">← Back</a>
                <form action="" class='filters-form'>
                    <?php echo csrf_field(); ?>
                    <input type="hidden" name="address" id="address_hidden" value="<?php echo e($quoteData['address'] ?? ''); ?>">
                        ...
                        <div class="addons-div" id="addonsDiv">
                            <?php $__currentLoopData = $addons; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $addon): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="more-options">
                                    <input type="checkbox" id="addon_<?php echo e($addon->id); ?>" name="addons[]" value="<?php echo e($addon->id); ?>" <?php echo e(in_array($addon->id, $selectedAddons) ? 'checked' : ''); ?>>
                    ...
                    <div class="form-group-field">
                        ...
                        <div class="services-div mb-3" id="servicesDiv" style="display: none;">
                            <?php $__currentLoopData = $services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="more-options">
                                    <input type="checkbox" class="service-checkbox" name="services[]" value="<?php echo e($service->id); ?>" id="service_<?php echo e($service->id); ?>" <?php echo e(in_array($service->id, $selectedServices) ? 'checked' : ''); ?>>
                                    <label for="service_<?php echo e($service->id); ?>"><?php echo e($service->service_name); ?> - $<?php echo e(number_format($service->price, 2)); ?></label><br>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                    </div>
                                    ...
                                    <div class="card-body mb-2">
                                        ...
                                        <?php if(!empty($employee->available_slots)): ?>
                                            <?php $__currentLoopData = $employee->available_slots; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $slot): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <span class='timeslotstext' data-slot="<?php echo e($slot); ?>" data-employee-id="<?php echo e($employee->id); ?>"><?php echo e($slot); ?></span>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        <?php else: ?>
...
<script>
   $(document).on('click', '.timeslotstext', function() {
        ...
        $.ajax({
        url: "<?php echo e(route('check.employee.service')); ?>",
        method: "POST",
        data: {
            _token: '<?php echo e(csrf_token()); ?>',
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/2025 Projects/A1ClassicGarage/resources/views/frontend/quote-extended.blade.php ENDPATH**/ ?>