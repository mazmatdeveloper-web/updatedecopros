  ...
  <div style="max-width:700px; margin: 40px auto; background:#ffffff; border-radius:16px; box-shadow:0 12px 28px rgba(0,0,0,0.06); overflow:hidden;">
    ...
    <div style="padding: 40px 30px;">
      ...
      <div style="background:#f9fafc; padding:24px; border-radius:12px; border:1px solid #e6eaf0;">
        ...
        <p style="margin:8px 0;"><strong>Cleaner:</strong> <?php echo e($appointment->cleaner->name); ?></p>
        <p style="margin:8px 0;"><strong>Service:</strong> <?php echo e($appointment->service->service_name); ?></p>
        <?php
            use Carbon\Carbon;
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/2025 Projects/updatedecopros/resources/views/emails/updates/customer_appointment_update.blade.php ENDPATH**/ ?>