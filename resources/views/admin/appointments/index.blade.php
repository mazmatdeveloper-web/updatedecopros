                        ...
                        <div class="card-body">
                          ...
                          <td class='d-flex align-items-center gap-1'>
                                <a href="{{ route('edit.appointment', $appointment->id) }}">
                                    ...
                                    <form action="{{route('delete.appointment',$appointment->id)}}" method="POST" onsubmit="return confirm('Are you sure you want to delete this bedroom option?');" style="display:inline;">
                                        @csrf
                                        @method('DELETE')
